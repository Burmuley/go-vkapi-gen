...
git push -u origin "$br_name" -o merge_request.create -o merge_request.remove_source_branch merge_request.title="Auto-generated VK API SDK build. $(date)" -o merge_request.target=master || exit 1
